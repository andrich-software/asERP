...
namespace asToolkit.Server.Tests.Features.Tenant.Commands;
    ...
    private async Task SeedUserTenantsAsync()
    {
        ...
        try
        {
            ...
            if (!hasUserTenants)
            {
                ...
                var userTenantWithPermission = new asToolkit.Domain.Entities.UserTenant
                {
                    UserId = AdminUserId,
                ...
                var userTenantWithoutPermission = new asToolkit.Domain.Entities.UserTenant
                {
                ...
                var userTenant2WithPermission = new asToolkit.Domain.Entities.UserTenant
                {
                    UserId = AdminUserId,
