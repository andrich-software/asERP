...
public class ShippingLabelOutboxTests : TenantIsolatedTestBase
{
        ...
        bool providerExists = true, bool providerEnabled = true, int customerNumber = 841)
    {
        ...
        asToolkit.Domain.Entities.ShippingProvider? provider = null;
        asToolkit.Domain.Entities.ShippingProviderRate? rate = null;
        if (providerExists)
        {
        ...
        var shipping = new asToolkit.Domain.Entities.Shipping
        {
            Id = Guid.NewGuid(),
            SalesId = sales.Id,
    ...
    private ShippingLabelOutbox AddOutboxRow(asToolkit.Domain.Entities.Shipping shipping,
