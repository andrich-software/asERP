...
{
    private async Task<(asToolkit.Domain.Entities.ShippingProviderRate Rate,
        asToolkit.Domain.Entities.Sales Sales)> SeedSetupAsync(
    ...
    public async Task PartialQuantityShipment_ShouldLeaveOrderPartiallyDelivered()
    {
        ...
        TestAssertions.AssertEqual(asToolkit.Domain.Enums.SalesStatus.PartiallyDelivered, order.Status);
    }
}
