...
namespace asToolkit.Server.Tests.Features.Shipping;
...
public class ShippingTenantIsolationTests : TenantIsolatedTestBase
{
    private async Task<(asToolkit.Domain.Entities.ShippingProvider Provider,
        ...
        asToolkit.Domain.Entities.Sales Sales,
        asToolkit.Domain.Entities.Shipping Shipping)> SeedTenant1DataAsync()
    {
