...
namespace asERP.Server.Tests.Features.Invoice.Queries;
...
public class InvoiceDetailQueryTests : IDisposable
{
    ...
    private async Task SeedInvoiceTestDataAsync()
    {
        ...
        try
        {
            ...
            if (!hasData)
            {
                ...
                var customer1 = new asERP.Domain.Entities.Customer
                {
                    Id = Guid.NewGuid(),
                ...
                var customer2 = new asERP.Domain.Entities.Customer
                {
                    Id = Guid.NewGuid(),
                ...
                var invoice1Tenant1 = new asERP.Domain.Entities.Invoice
                {
                    Id = Invoice1Id,
                    ...
                    TotalTax = 38.00m,
                    Total = 248.00m,
                    PaymentStatus = asERP.Domain.Enums.PaymentStatus.Invoiced,
                    InvoiceStatus = asERP.Domain.Enums.InvoiceStatus.Created,
                ...
                var invoice2Tenant2 = new asERP.Domain.Entities.Invoice
                {
                    Id = Invoice2Id,
                    ...
                    TotalTax = 19.00m,
                    Total = 119.00m,
                    PaymentStatus = asERP.Domain.Enums.PaymentStatus.CompletelyPaid,
                    InvoiceStatus = asERP.Domain.Enums.InvoiceStatus.Sent,
                    TenantId = TenantConstants.TestTenant2Id
                };

                DbContext.Invoice.AddRange(invoice1Tenant1, invoice2Tenant2);

                var invoiceItem1 = new asERP.Domain.Entities.InvoiceItem
                {
                    Id = InvoiceItem1Id,
                ...
                var invoiceItem2 = new asERP.Domain.Entities.InvoiceItem
                {
                    Id = InvoiceItem2Id,
                    InvoiceId = Invoice1Id,
                    ProductId = Product1Id,
    ...
    public async Task GetInvoiceDetail_ShouldIncludeAllBasicFields()
    {
        ...
        TestAssertions.AssertEqual(asERP.Domain.Enums.PaymentStatus.Invoiced, invoice.PaymentStatus);
        TestAssertions.AssertEqual(asERP.Domain.Enums.InvoiceStatus.Created, invoice.InvoiceStatus);
