    ...
    private async Task SeedTestDataAsync()
    {
        ...
        try
        {
            ...
            if (!hasData)
            {
                ...
                var invoice2Tenant1 = new asERP.Domain.Entities.Invoice
                {
                    Id = Invoice2Id,
                ...
                var invoice3Tenant2 = new asERP.Domain.Entities.Invoice
                {
                    Id = Invoice3Id,
                ...
                var invoice4WithItems = new asERP.Domain.Entities.Invoice
                {
                    Id = Invoice4Id,
