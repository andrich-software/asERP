...
namespace asERP.Server.Tests.Features.Product.Commands;
...
public class ProductDeleteCommandTests : TenantIsolatedTestBase
{
    ...
    private async Task<(Guid tenant1ProductId, Guid tenant2ProductId)> SeedTestDataAsync()
    {
        ...
        try
        {
            ...
            if (!hasData)
            {
                ...
                var taxClass2 = new asERP.Domain.Entities.TaxClass
                {
                    Id = TaxClass2Id,
                    TaxRate = 20.0,
                ...
                var manufacturer = new asERP.Domain.Entities.Manufacturer
                {
                    Id = Manufacturer1Id,
                ...
                var manufacturer2 = new asERP.Domain.Entities.Manufacturer
                {
                    Id = Manufacturer2Id,
                ...
                var product1 = new asERP.Domain.Entities.Product
                {
                    Id = Product1Id,
                    Sku = "TEST-DELETE-001",
                ...
                var product2 = new asERP.Domain.Entities.Product
                {
                    Id = Product2Id,
                    Sku = "TEST-DELETE-002",
                ...
                var product3 = new asERP.Domain.Entities.Product
                {
                    Id = Product3Id,
                    Sku = "TEST-DELETE-003",
    ...
    {
        var dto = new asERP.Domain.Dtos.ProductAttribute.ProductAttributeInputDto
        {
            Name = name,
            SortOrder = 0,
            Values = values.Select((v, i) => new asERP.Domain.Dtos.ProductAttribute.ProductAttributeValueInputDto
            {
                Value = v,
                SortOrder = i
            }).ToList()
        ...
        var attrDetail = await ReadResponseAsync<Result<asERP.Domain.Dtos.ProductAttribute.ProductAttributeDetailDto>>(detailResponse);
    ...
    public async Task DeleteProduct_VariantParent_ShouldCascadeDeleteVariants()
    {
        ...
        var parentDto = new asERP.Domain.Dtos.Product.ProductInputDto
        {
            Sku = $"CASC-VP-{Guid.NewGuid():N}",
            Name = "Cascade Parent",
            Price = 0m,
            TaxClassId = TaxClass1Id,
            ProductType = asERP.Domain.Enums.ProductType.VariantParent,
        ...
        for (var i = 0; i < 2; i++)
        {
            var variantDto = new asERP.Domain.Dtos.Product.ProductInputDto
            {
                Sku = $"CASC-VAR-{i}-{Guid.NewGuid():N}",
                Name = $"Cascade Variant {i}",
                Price = 5m,
                TaxClassId = TaxClass1Id,
                ProductType = asERP.Domain.Enums.ProductType.Variant,
