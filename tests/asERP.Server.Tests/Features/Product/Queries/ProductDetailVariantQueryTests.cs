    ...
    private async Task SeedVariantTreeAsync()
    {
        ...
        try
        {
            if (!await DbContext.Product.AnyAsync())
            {
                ...
                DbContext.TaxClass.Add(new asERP.Domain.Entities.TaxClass
                {
                    Id = TaxClass1Id,
                    TaxRate = 19.0,
                ...
                DbContext.ProductAttribute.Add(new asERP.Domain.Entities.ProductAttribute
                {
                    Id = AttributeId,
                    Name = "Länge",
                    SortOrder = 0,
                    TenantId = TenantConstants.TestTenant1Id,
                    Values = new List<asERP.Domain.Entities.ProductAttributeValue>
                    {
                ...
                DbContext.Product.Add(new asERP.Domain.Entities.Product
                {
                    Id = ParentId,
                    Sku = "VD-PARENT",
                    Name = "Variant Parent",
                    ...
                    TenantId = TenantConstants.TestTenant1Id,
                    VariantAxes = new List<asERP.Domain.Entities.ProductVariantAxis>
                    {
                ...
                DbContext.Product.Add(new asERP.Domain.Entities.Product
                {
                    ...
                    TenantId = TenantConstants.TestTenant1Id,
                    VariantOptions = new List<asERP.Domain.Entities.ProductVariantOption>
                    {
