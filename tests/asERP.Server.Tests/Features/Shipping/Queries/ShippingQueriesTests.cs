...
public class ShippingQueriesTests : TenantIsolatedTestBase
{
    ...
    public async Task GetDetail_History_ShouldReturnOwnEntriesNewestFirst()
    {
        ...
        var older = new asERP.Domain.Entities.SalesHistory
        {
            Id = Guid.NewGuid(),
            SalesId = sales.Id,
        ...
        var newer = new asERP.Domain.Entities.SalesHistory
        {
            Id = Guid.NewGuid(),
            SalesId = sales.Id,
            ShippingId = shipping.Id,
        ...
        var foreign = new asERP.Domain.Entities.SalesHistory
        {
            Id = Guid.NewGuid(),
            SalesId = sales.Id,
        ...
        var orderLevel = new asERP.Domain.Entities.SalesHistory
        {
            Id = Guid.NewGuid(),
            SalesId = sales.Id,
            ShippingId = null,
