...
namespace asERP.Server.Tests.Features.Customer.Queries;
...
public class CustomerDetailQueryTests : TenantIsolatedTestBase
{
    ...
    private async Task SeedCustomerTestDataAsync()
    {
        ...
        var customerAddress1 = new asERP.Domain.Entities.CustomerAddress
        {
        ...
        var customerAddress2 = new asERP.Domain.Entities.CustomerAddress
        {
