...
namespace asERP.Server.Tests.Features.AiModel.Queries;
...
public class AiModelListQueryTests : TenantIsolatedTestBase
{
    ...
    [Fact]
    public async Task GetAiModels_WithSortByName_ShouldReturnSalesedResults()
    {
        // Arrange
        await TestDataSeeder.SeedTestDataAsync(DbContext, TenantContext);
        SetTenantHeader(TenantConstants.TestTenant1Id);
        ...
        // Act
        var response = await Client.GetAsync("/api/v1/AiModels?sortBy=Name");
    ...
    [Fact]
    public async Task GetAiModels_WithSortByNameDescending_ShouldReturnDescSalesedResults()
    {
        // Arrange
        await TestDataSeeder.SeedTestDataAsync(DbContext, TenantContext);
        SetTenantHeader(TenantConstants.TestTenant1Id);
        ...
        // Act
        var response = await Client.GetAsync("/api/v1/AiModels?sortBy=Name desc");
    ...
    [Fact]
    public async Task GetAiModels_WithMultipleSortBy_ShouldRespectMultipleSorting()
    {
        // Arrange
        await TestDataSeeder.SeedTestDataAsync(DbContext, TenantContext);
        SetTenantHeader(TenantConstants.TestTenant1Id);
        ...
        // Act
        var response = await Client.GetAsync("/api/v1/AiModels?sortBy=AiModelType,Name");
