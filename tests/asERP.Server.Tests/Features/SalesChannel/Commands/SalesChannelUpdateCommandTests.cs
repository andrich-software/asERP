...
public class SalesChannelUpdateCommandTests : TenantIsolatedTestBase
{
    ...
    private async Task SeedTestDataAsync()
    {
        ...
        try
        {
            ...
            if (existingSalesChannel == null)
            {
                ...
                {
                    warehouse1 = new asERP.Domain.Entities.Warehouse
                    {
                        Id = TestWarehouse1Id,
                ...
                var salesChannel1 = new asERP.Domain.Entities.SalesChannel
                {
                    ...
                    ExportSaless = false,
                    TenantId = TenantConstants.TestTenant1Id,
                    Warehouses = new List<asERP.Domain.Entities.Warehouse> { warehouse1 }
                };

                var salesChannel2 = new asERP.Domain.Entities.SalesChannel
                {
                ...
                var salesChannel3 = new asERP.Domain.Entities.SalesChannel
                {
                    ...
                    ExportSaless = true,
                    TenantId = TenantConstants.TestTenant2Id,
                    Warehouses = new List<asERP.Domain.Entities.Warehouse> { warehouse3 }
                };
    ...
    [Fact]
    public async Task UpdateSalesChannel_WithEmptyWarehouseIds_ShouldReturnBadRequest()
    {
        await SeedTestDataAsync();
        SetTenantHeader(TenantConstants.TestTenant1Id);
        var updateDto = CreateUpdateSalesChannelDto(TestSalesChannel1Id);
        updateDto.WarehouseIds = new List<Guid>(); // At least one warehouse is now required
