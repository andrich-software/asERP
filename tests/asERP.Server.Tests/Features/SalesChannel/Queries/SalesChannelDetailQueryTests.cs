    ...
    private async Task SeedTestDataAsync()
    {
        ...
        try
        {
            ...
            if (existingSalesChannel == null)
            {
                ...
                var salesChannel1_1 = new asERP.Domain.Entities.SalesChannel
                {
                    ...
                    Warehouses = new List<asERP.Domain.Entities.Warehouse> { warehouse1, warehouse2 }
                };

                var salesChannel1_2 = new asERP.Domain.Entities.SalesChannel
                {
                ...
                var salesChannel2_1 = new asERP.Domain.Entities.SalesChannel
                {
