...
namespace asERP.Server.Tests.Features.Tenant.Queries;
    ...
    private async Task SeedUserTenantsAsync()
    {
        ...
        try
        {
            ...
            if (!hasUserTenants)
            {
                ...
                var userTenant1 = new asERP.Domain.Entities.UserTenant
                {
                    UserId = AdminUserId,
                ...
                var userTenant2 = new asERP.Domain.Entities.UserTenant
                {
                    UserId = AdminUserId,
                ...
                var user2Tenant1 = new asERP.Domain.Entities.UserTenant
                {
                    UserId = User2Id,
                    TenantId = TenantConstants.TestTenant1Id,
                    IsDefault = true,
