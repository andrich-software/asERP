    ...
    private async Task SeedUserTenantsAsync()
    {
        ...
        try
        {
            ...
            if (!hasUserTenants)
            {
                ...
                var userTenantWithPermission = new asERP.Domain.Entities.UserTenant
                {
                    UserId = AdminUserId,
                ...
                var userTenantWithoutPermission = new asERP.Domain.Entities.UserTenant
                {
                ...
                var userTenant2WithPermission = new asERP.Domain.Entities.UserTenant
                {
                    UserId = AdminUserId,
