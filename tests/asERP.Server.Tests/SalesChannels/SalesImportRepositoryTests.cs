...
public class SalesImportRepositoryTests
{
    ...
    {
        public Task<TResponse> Send<TResponse>(asERP.Application.Mediator.IRequest<TResponse> request, CancellationToken cancellationToken = default)
            => throw new NotSupportedException();

        public Task Publish<TNotification>(TNotification notification, CancellationToken cancellationToken = default)
            where TNotification : asERP.Application.Mediator.INotification
            => Task.CompletedTask;
    }
