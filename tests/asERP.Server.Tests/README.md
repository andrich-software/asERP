...
Dieses Test-Projekt enthält Integration Tests für die asERP.Server API mit besonderem Fokus auf Multi-Tenancy.
...
```bash
# Alle Tests
dotnet test tests/asERP.Server.Tests/

# Spezifische Test-Klasse
dotnet test tests/asERP.Server.Tests/ --filter "FullyQualifiedName~AiModelListQueryTests"

# Spezifischer Test
dotnet test tests/asERP.Server.Tests/ --filter "FullyQualifiedName~GetAiModels_WithValidTenant_ShouldReturnTenantSpecificModels"
```
