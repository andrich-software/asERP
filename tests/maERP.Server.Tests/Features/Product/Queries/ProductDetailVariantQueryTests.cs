    ...
    private async Task SeedVariantTreeAsync()
    {
        ...
        try
        {
            if (!await DbContext.Product.AnyAsync())
            {
                ...
                DbContext.TaxClass.Add(new maERP.Domain.Entities.TaxClass
                {
                    Id = TaxClass1Id,
                    TaxRate = 19.0,
                ...
                DbContext.ProductAttribute.Add(new maERP.Domain.Entities.ProductAttribute
                {
                    Id = AttributeId,
                    Name = "Länge",
                    SortOrder = 0,
                    TenantId = TenantConstants.TestTenant1Id,
                    Values = new List<maERP.Domain.Entities.ProductAttributeValue>
                    {
                ...
                DbContext.Product.Add(new maERP.Domain.Entities.Product
                {
                    Id = ParentId,
                    Sku = "VD-PARENT",
                    Name = "Variant Parent",
                    ...
                    TenantId = TenantConstants.TestTenant1Id,
                    VariantAxes = new List<maERP.Domain.Entities.ProductVariantAxis>
                    {
                ...
                DbContext.Product.Add(new maERP.Domain.Entities.Product
                {
                    ...
                    TenantId = TenantConstants.TestTenant1Id,
                    VariantOptions = new List<maERP.Domain.Entities.ProductVariantOption>
                    {
