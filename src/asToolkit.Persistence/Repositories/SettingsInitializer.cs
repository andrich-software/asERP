    ...
    public class SettingsInitializer
    {
        ...
        private static List<Setting> GetRequiredSettings()
        {
            ...
            return new List<Setting>
            {
                ...
                new Setting { Key = "Jwt.Issuer", Value = "asToolkit.Server" },
                new Setting { Key = "Jwt.Audience", Value = "asToolkit.Client" },
                ...
                new Setting { Key = "Email.FromAddress", Value = "noreply@astoolkit.local" },
                new Setting { Key = "Email.FromName", Value = "asToolkit System" },
                ...
                new Setting { Key = "ClickHouse.Database", Value = Environment.GetEnvironmentVariable("CLICKHOUSE_DB") ?? "astoolkit_analytics" },
                new Setting { Key = "ClickHouse.User", Value = Environment.GetEnvironmentVariable("CLICKHOUSE_USER") ?? "astoolkit" },
                new Setting { Key = "ClickHouse.Password", Value = Environment.GetEnvironmentVariable("CLICKHOUSE_PASSWORD") ?? "astoolkit" },
