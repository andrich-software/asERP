...
namespace asToolkit.Persistence.Seeders;
...
public static class SettingsSeeder
{
    public static void SeedSettings(this ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Setting>().HasData(
            ...
            new Setting { Id = new Guid("66666666-6666-6666-6666-666666666621"), Key = "Email.FromName", Value = "asToolkit" },
            ...
            new Setting { Id = new Guid("66666666-6666-6666-6666-666666666623"), Key = "Telemetry.ServiceName", Value = "asToolkit.Server" }
