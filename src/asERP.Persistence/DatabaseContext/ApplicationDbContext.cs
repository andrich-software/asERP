...
using asERP.Identity.Configurations;
using asERP.Persistence.Configurations;
using asERP.Persistence.Seeders;
using asERP.Persistence.ValueConverters;
...
public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // and its IdentityPasskeyData complex type. asERP does not use passkeys, and the SQLite
