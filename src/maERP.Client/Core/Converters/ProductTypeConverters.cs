...
/// <summary>
/// Joins a list of <see cref="maERP.Domain.Dtos.Product.ProductVariantOptionDto"/> values
...
public class VariantOptionsSummaryConverter : IValueConverter
{
    public object Convert(object value, Type targetType, object parameter, string language)
    {
        if (value is IEnumerable<maERP.Domain.Dtos.Product.ProductVariantOptionDto> options)
        {
