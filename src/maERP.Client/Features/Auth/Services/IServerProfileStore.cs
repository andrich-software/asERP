...
/// <summary>
/// Persists the list of known maERP servers locally and tracks which one was used last.
/// The built-in maERP Cloud entry (<see cref="ServerProfile.BuiltInId"/>) is always present
...
public interface IServerProfileStore
{
    ...
    /// Guarantees the built-in maERP Cloud entry is present and migrates a legacy single
