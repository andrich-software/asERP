        ...
        try {
            ...
            iframe.onload = function () {
                try {
                    ...
                    console.warn("asToolkitLabels.print: iframe print failed, opening tab", e);
            ...
            console.warn("asToolkitLabels.print: falling back to window.open", e);
            window.open(url, "_blank");
