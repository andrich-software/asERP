...
using asToolkit.Client.Features.AiPrompts.Services;
using asToolkit.Domain.Dtos.AiPrompt;

namespace asToolkit.Client.Features.AiPrompts.Models;
...
public partial record AiPromptListModel
{
    ...
    /// </summary>
    public IState<string> ActiveSortField => State<string>.Value(this, () => "DateModified");
