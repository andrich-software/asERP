...
using asToolkit.Client.Features.Invoices.Services;
using asToolkit.Domain.Dtos.Invoice;

namespace asToolkit.Client.Features.Invoices.Models;
...
public partial record InvoiceListModel
{
    ...
    /// </summary>
    public IState<string> ActiveSortField => State<string>.Value(this, () => "InvoiceDate");
