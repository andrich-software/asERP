...
/// <summary>
/// Persists the list of known asERP servers locally and tracks which one was used last.
/// The built-in asERP Cloud entry (<see cref="ServerProfile.BuiltInId"/>) is always present
...
public interface IServerProfileStore
{
    ...
    /// Guarantees the built-in asERP Cloud entry is present and migrates a legacy single
