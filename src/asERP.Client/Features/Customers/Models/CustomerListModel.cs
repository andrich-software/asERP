...
namespace asERP.Client.Features.Customers.Models;
...
public partial record CustomerListModel
{
    ...
    /// </summary>
    public IState<string> ActiveSortField => State<string>.Value(this, () => "DateEnrollment");
    ...
    /// </summary>
    public IState<PaginationInfo> Pagination => State<PaginationInfo>.Value(this, () => new PaginationInfo(_localizer));
...
public record PaginationInfo
{
    ...
    public PaginationInfo(IStringLocalizer localizer) => _localizer = localizer;
